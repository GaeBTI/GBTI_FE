const TESTS = [
	...
	},
	{
		id: 3,
        type:'TnF',
		question: <>선배가 나를 불러<br/>“너 그렇게 행동하면<br/>아무도 너 안 좋아해”라고 했다.<br/>이때의 나의 반응은?</>,
		answers: [
			{ text: "아  예.. (어쩌라는거지)", clickedFirst:true  }, //"어쩔티비 너나 잘하세요~"
			{ text: <>헐... (마상..)<br/> 어떻게 저런 심한 말을 하지…?</>, clickedFirst:false },
		],
	},
    {
		id: 4,
	...
	},
	{
		id: 9,
        type:'EnI',
		question: <>수업이 끝나고 폰을 보니<br/>과 단톡에 3시간 뒤<br/>뫄뫄학과 개강총회가 열린다는<br/>공지가 올라왔다.</>,
		answers: [
			{ text: <>당장 가야지!!<br/>오랜만에 동기들도 보고 기대된당<br/>^0^</>, clickedFirst:true },
			{ text: <>상상만 해도 기빨려..<br/>그리고 3시간동안 뭐하면서 기다려..<br/>집에나 갈래</>, clickedFirst:false },
		],
	},
	{
		id: 10,
        type:'NnS',
		question: <>교수님이 리포트 주제로<br/>“가위바위보의 유래”를 주셨다.</>,
		answers: [
			{ text: "가위바위보는 누가 가장 먼저 시작했을까? 왜 하기 시작한거지? 신기하다!!", clickedFirst:true },
			{ text: <>가위바위보 저작권 등록했으면<br/>돈 많이 벌었을텐데..ㅎ</>, clickedFirst:false },
		],
	},
	{
		id: 11,
        type:'TnF',
		question: <>프로젝트 발표 후 수업을<br/>같이 들은 동기들이 칭찬을 해줬다.<br/>어떤 칭찬이 더 기분 좋을까?</>,
		answers: [
			{ text: <>신경 별로 안쓰는 것 같더니<br/>진짜 잘했네. 천재 아니야..???</>, clickedFirst:true }, //별로 열심히 하는 것 같지도 않았는데
			{ text: <>진짜 수고 많았어!<br/>열심히 하더니 진짜 너가 제일 잘한듯!!</>, clickedFirst:false  },
		],
	},
    {
		id: 12,
        type:'PnJ',
		question: <>교수님이 과제를 내주셨다.<br/>마감은 7일 후 자정이다.</>,
		answers: [
			{ text: <>지금 당장 계획짜기 시작!<br/>과제는 나온 날 시작해야지!</>, clickedFirst:false  },
